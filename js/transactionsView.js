$(document).ready(function() {
    ...
    $(".dropdown-menu li a").click(function () {
        ...
        function paintMonthlyChart(month,year) {
            ...
            donutChartData = [moneySpentOnACategoryPerMonth(month, year, "Transport "), moneySpentOnACategoryPerMonth(month, year, "Clothing "), moneySpentOnACategoryPerMonth(month, year, "Entertainment "), moneySpentOnACategoryPerMonth(month, year, "Food "), moneySpentOnACategoryPerMonth(month, year, "Health "), moneySpentOnACategoryPerMonth(month, year, "Personal ")]
