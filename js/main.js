$(document).ready(function() {
  ...
  if(localStorage.visited){
    localStorage.setItem("visited", false);
      ...
      introJs()
        ...
        .start()
        .oncomplete(function() {
          window.location.href = "/pages/transactions-view.html";
        });
  }
  ...
  $("#save").on("click", function() {
    ...
    var individualExpenses = split(cells.slice(), cells.length / (rowIds.length - 2));
    ...
    $("tbody").text("");
    $("tbody").append('<tr id="addExpenseInfo"><td colspan="6"><div class="expenseTableHeader text-center">Add Expense</div></td></tr>');
    $("tbody").append('<tr id="expenseSuccessSavedTableHeader"><td colspan="6"><div class="expenseSuccessSavedTableHeader text-center">All expenses successfully saved</div></td></tr>');
