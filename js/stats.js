$(document).ready(function() {
    ...
    var automobileTotalExpense = generateYearlyExpenseByCategory("Transport ");
    ...
    var healthcareTotalExpense = generateYearlyExpenseByCategory("Health ");
    var vacationTotalExpense = generateYearlyExpenseByCategory("Personal ");
    ...
    var yearlyAutomobileExpenses = generateMonthlyCategoryExpenses("Transport ");
    var yearlyEntertainmentExpenses = generateMonthlyCategoryExpenses("Entertainment ");
    var yearlyVacationExpenses = generateMonthlyCategoryExpenses("Personal ");
    var yearlyFoodExpenses = generateMonthlyCategoryExpenses("Food ");
    var yearlyHealthcareExpenses = generateMonthlyCategoryExpenses("Health ");
    ...
    var config = {
        type: "doughnut",
        data: {
            "labels": ["Transport", "Clothing", "Entertainment", "Food", "Health", "Personal"],
            "datasets": [{
